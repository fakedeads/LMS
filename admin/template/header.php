...
<head>
<meta charset="utf-8">
<title>Admin | Lab Management System</title>
      ...
      <div class="nav-collapse">
        <ul class="nav pull-right">
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user">Welcome : </i> <?php echo $data['nama_user']?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
			  <li><a href="javascript:;"><img src="../tatausaha/user/foto_user/<?php echo $data['foto']?>" width=120 height=100 title="<?php echo $data['nama_user']?>" class="img-thumbnail"></a></li>
...
<div class="control-group">
	<div class="controls">
		<!-- Modal -->
		<form id="form" action="konfirmasi.php?action=change_password" method="post" >
