	  ...
	  <form id="form" enctype="multipart/form-data"  action="" method="post">
			 <div class="span3">
				 ...
				 <div class="widget-content">
					 <img src="../tatausaha/user/foto_user/<?php echo $data['foto']?>" width=230 height=200 title="<?php echo $data['nama_user']?>" class="img-thumbnail"></a>
			 ...
			 <div class="span8">
				 ...
				 <div class="widget-content">
					...
					<tbody>
			          <tr>
			          	<td>Id Pengenal: </td> 
			          	<td><input  id="id_pengenal" name="id_pengenal" type="text" value="<?php echo $data['id_pengenal']?>" disabled="disabled"></td>
			          </tr>
					  <tr>
			          	<td>Nama Lengkap :</td> 
			          	<td><input id="nama_user" name="nama_user" type="text" value="<?php echo $data['nama_user']?>"></td>
					  </tr>
			          <tr>
			          	<td>No Handphone :</td> 
...
<?php
	...
	//if(empty($lokasi_file)){
		$query="UPDATE tb_user SET
			...
			if($result == 1)
		{
			//echo "selamat anda berhasil terdaftar";
			//echo "<center><font color=#FF0000 size=5>Data berhasil dirubah</font>";
			echo "<script>
