...
<form action="act_insert_atk.php" method="post" enctype="multipart/form-data" name="form1" id="form1" align="center">
		
  <table width="606" border="0" cellpadding="5" cellspacing="0" align="center">
    <!--DWLayoutTable-->
    <tr>
      <td height="44" colspan="3" valign="top"><span class="style3">Form Input ATK</span></td>
    </tr>
    <tr>
	...
	<tr>
      ...
      <td align="left" valign="top">:</td>
      <td align="left" valign="top"><span class="style1">
        <textarea name="type" cols="25"></textarea>
      </span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="top">:</td>
      <td align="left" valign="top"><span class="style1">
	  <input name="stok" type="hidden"  value="Tersedia" />
