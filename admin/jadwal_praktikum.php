        ...
        <div class="span12">
          <div class="widget widget-nopad">
            <div class="widget-header"> <i class="icon-list-alt"></i>
              <h3>Halaman Administrator <?php echo $data['nama_mhs']?></h3>
            </div>
            <!-- /widget-header -->
              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
					...
					<tbody>
						...
						$no=1;
						$query = mysql_query("SELECT tb_jadwal_praktikum.nim, 	tb_jadwal_praktikum.id_asisten, tb_jadwal_praktikum.group, 
					...
					?>
					  <tr>
						...
						<td class="td-actions"><a href="#"onclick="return confirm('Anda yakin tukar jadwal praktikum dengan : <?php echo $data['nama_mhs'];?> ?')" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok" title="Tukar Jadwal"> </i></a></td>
					  </tr>
					  <?php 
						$no++;
					} 
