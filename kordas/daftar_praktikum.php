				  ...
				  <table class="table table-striped table-bordered">
					...
					<?php 
					  ...
					  <tr>	
						...
						<td class="td-actions"><a href="nilai_praktikum.html?modul=<?php echo $row['kd_mk'] ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-book" title="Lihat Nilai Praktikum"> </i></a></td>
					  </tr>
					  <?php 
						$no++;
					} 
