	...
	<div class="row">
		...
		<div class="span12">
			...
			<div class="error-container">
				<h2 style="color:#d50000">404</h2>
				<h2 style="color:#d50000">Maaf, halaman yang Anda akses tidak ditemukan.</h2>
				<img src="img/labms.png" class="error-container">
