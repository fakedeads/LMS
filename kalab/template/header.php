...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.php"><img src="../img/<?php echo $info['logo'];?>" alt=""></a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
		<?php
				$email = $_SESSION['email'];
				$data=mysql_fetch_array(mysql_query("select * from tb_user where email ='$email'"));
				$id = $data['id_pengenal'];
			?>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="daftar_praktikum.html"><i class="icon-tasks"></i><span>Hasil Penilaian</span> </a> </li>
        <li><a href="generate_laporan_praktikum.html"><i class="icon-list"></i><span>Generate Laporan</span> </a> </li>
