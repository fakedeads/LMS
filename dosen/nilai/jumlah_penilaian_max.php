  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="../course_categories_dosen.php"><i class="icon-list"></i><span>Nilai Praktikan</span> </a> </li>
...
?>
					...
					<span style="font-size: 14px;"><a href="course_categories_dosen.php">Back</a></span>
				</div>
			</form>
		</div>
	</div>
