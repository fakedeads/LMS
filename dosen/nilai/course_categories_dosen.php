...
$cekDb=mysql_query("SELECT * FROM tb_mdl_coursecategories"); /*tambahan  where nip_dosen = '$idDosen'*/
?>
			...
			?>
				<tr>
					<td width="230px">
						...
						<div id="inti_2">
							<a
								href="jumlah_penilaian_max.php?idcategori=<?php echo $categories['id'];?>">
					...
					<td width="110" align="center">
						<font style="font-size: 12px"><a href="../../tatausaha/generate/jumlah_penilaian_max2.php?idcategori=<?php echo $categories['id'];?> " target="_blank">Generete Excel</a></font>
					</td>
					<td width="110" align="center">
						<font style="font-size: 12px;"><a href="../../tatausaha/generate/pdf_jumlah_penilaian.php?idcategori=<?php echo $categories['id'];?> " target="_blank">Generete PDF</a></font>
					</td>
				</tr>
				<?php
				endwhile;
