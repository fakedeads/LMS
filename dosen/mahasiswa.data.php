...
<tbody>
	...
	<tr>
		...
		<td class="alert alert-success td-actions"><a href="konfirmasi.php?action=delmhs&nim=<?php echo $data['nim'] ?>" onclick="return confirm('Apakah Anda yakin menghapus data Mahasiswa : <?php echo $data['nama_mhs'];?> ?')"class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
	</tr>
	<?php
		$i++;
		}
