						...
						?>
						  <ul class="messages_layout">
							...
							<?php 
								...
								?>
								<a href="#" class="avatar"><img src="foto_dosen/<?php echo $row7['foto'] ?>" width="70" height="70"/></a>
								<?php
										...
										<input id="id" name="id" value="<?php echo $id ?>" type="hidden">
											<table class="table table-badge-success">
												<tr>
													...
													<td class="alert-info"><input id="username" name="username" value="<?php echo $user ?>" type="hidden"/>
													<input id="" name="" value="<?php echo $user ?>" type="text" disabled/></td>
												</tr>
												<tr>
		  ...
		  <div class="modal-body">
			...
			<input id="id" name="id" value="<?php echo $id; ?>" type="hidden">
				<table class="table table-badge-success">
					<tr>
						<td class="alert-info">Username*</td>
						<td class="alert-info"><input id="username" name="username" value="<?php echo $data['username']?>" type="hidden"/>
						<input id="" name="" value="<?php echo $data['username']?>" type="text" disabled/></td>
					</tr>
					<tr>
						<td class="alert-info">Topik*</td>
