  ...
  <div class="subnavbar-inner">
    <div class="container">
       <ul class="mainnav">
		...
		<li><a href="tampil_brg_inventaris.php"><i class="icon-list"></i><span>Informasi Barang Inventaris</span> </a> </li>
		<li><a href="tampil_brg_equipment.php"><i class="icon-list"></i><span>Informasi Barang Equipment</span> </a> </li>
