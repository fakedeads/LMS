...
echo"<tr class='odd gradeU'>
	...
	<a href=\"#myModalid$data7[kode_alat]\" title=\"Edit\" role=\"button\" class=\"btn btn-warning\" data-toggle=\"modal\"><i class=\"icon-edit\"></i></a><a href=\"detail_inventaris.php?Kode_Alat=$data7[kode_alat]\" target=\"_blank\" title=\"Detail\" role=\"button\" class=\"btn btn-warning\"><i class=\"icon-info-sign\"></i></a>
...
<div id="myAdd" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">Tambah Data ya sis</h3>
  </div>
  <div class="modal-body">
 <!--< <div class="alert">
