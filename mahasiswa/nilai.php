		  ...
		  -->
            ...
            <div class="widget-content">
				...
				<table width="700">
					...
					<tr>
						<td><h4>Nama Asisten / NIM </h4>
						<?php 
							$query=mysql_query("SELECT tb_jadwal_praktikum.id_asisten, tb_user.nama_user
								FROM tb_jadwal_praktikum
								INNER JOIN tb_user ON tb_jadwal_praktikum.id_asisten = tb_user.id_pengenal
								WHERE tb_jadwal_praktikum.kd_modul =  '$kd_modul'");
						$row2=mysql_fetch_array($query);
						?>
						</td>
						<td align="center"><h4>:</h4></td>
						<td><h4><?php echo  $row2['nama_user']?> / <?php echo  $row2['id_asisten']?></h4></td>
					</tr>
				</table>
				<br/>
