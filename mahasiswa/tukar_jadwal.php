	...
	<div class="container ">
      <div class="row">
        <div class="span12">
				...
				<i class="icon-user"></i>
				<h3> Halaman Tukar Jadwal Praktikum&nbsp;</h3> 
			...
			<tbody>
				...
				tb_jadwal_praktikum.nim, 	tb_jadwal_praktikum.id_asisten, 
				...
				tb_jadwal_praktikum.group, 
						...
						tb_matakuliah.nip_dosen, tb_mdl_praktikum.kd_mk, tb_mdl_praktikum.kd_modul, tb_mdl_praktikum.nm_modul, tb_mdl_praktikum.singkatan, tb_mahasiswa.nim, tb_mahasiswa.nama_mhs,
						tb_mahasiswa.hp,tb_mahasiswa.email, tb_user.id_pengenal, tb_user.nama_user, tb_dosen.nama_dosen
					...
					where tb_jadwal_praktikum.kd_modul='$kd_modul' and tb_jadwal_praktikum.nim!='$nim'
		  ...
		  $query1 = mysql_query("SELECT 
				...
				tb_jadwal_praktikum.nim, 	tb_jadwal_praktikum.id_asisten, tb_jadwal_praktikum.group, 
						...
						tb_matakuliah.semester,
						tb_matakuliah.akademik,
						tb_matakuliah.nip_dosen, tb_mdl_praktikum.kd_mk, tb_mdl_praktikum.kd_modul, tb_mdl_praktikum.nm_modul, tb_mdl_praktikum.singkatan, tb_mahasiswa.nim, tb_mahasiswa.nama_mhs, tb_mahasiswa.hp, tb_mahasiswa.email,tb_user.id_pengenal, tb_user.nama_user, tb_dosen.nama_dosen
					FROM tb_jadwal_praktikum
					INNER JOIN tb_matakuliah ON tb_jadwal_praktikum.kd_mk = tb_matakuliah.kd_mk
					INNER JOIN tb_mdl_praktikum ON tb_jadwal_praktikum.kd_modul = tb_mdl_praktikum.kd_modul
					INNER JOIN tb_mahasiswa ON tb_jadwal_praktikum.nim = tb_mahasiswa.nim
					  ...
					  <div class="modal-body">
						...
						<table id="tabel2" class="table table-badge-success">
							<tr>
								...
								<input  id="nim" name="nim" type="hidden" value="<?php echo $nim?>" />
								<input  id="namafrom" name="namafrom" type="hidden" value="<?php echo $namafrom ?>" />
								<input  id="emailfrom" name="emailfrom" type="hidden" value="<?php echo $email ?>" />
								</td>
							</tr>
							<tr>
								<td class="alert-info"> NIM Tujuan </td>
								<td class="alert-info"> <input type="text" name="" id="" value="<? echo $data['nim']?>" disabled/>
								<input  id="nim_mhs" name="nim_mhs" type="hidden" value="<?php echo $nim_mhs?>" />
								<input type="hidden" name="hp" value="<?php echo $data['hp']; ?>">  
								<input type="hidden" name="email" value="<?php echo $data['email']; ?>"> </td>
							</tr>
							<tr>
