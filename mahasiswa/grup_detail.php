      ...
      <div class="span3">
          ...
          <div class="widget-content">
            <ul class="nav nav-tabs nav-stacked">
              <?php
                $query=mysql_query("SELECT * FROM tb_grup_member where nim_mhs='$nim'");
                      ...
                      <div class="row-fluid">
                        <form action="action.php?action=add_post_grup" enctype="multipart/form-data" method="POST">
                          ...
                          <div class="control-group">
                            ...
                            <input type="text" name="nim_mhs" value="<?php echo $nim;?>" style="display:none;" readonly>
                              <div class="controls">      
                        ...
                        <ul class="media-list">
                          ...
                          <li class="media">
                            ...
                            <div class="media-right">
                              ...
                              <?php 
                                 $query_admin=mysql_query("SELECT level_member FROM tb_grup_member WHERE kode_grup='$kode' and nim_mhs='$id_mhs_dsn'");
                                  $row_admin = mysql_fetch_assoc($query_admin);
                                  $stat_admin =$row_admin['level_member'];
                                  if(!empty($stat_admin) && ($id_mhs_dsn == $nim)) {
                                  ?>
