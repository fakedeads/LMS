...
<table class="datatable" align="center" border="1">
	...
	<tr>
		...
		<td width="75" align="center"><a href="../logbook/pilih_waktu_logbook.php?idcategori=<?echo $idcategori?>&id=<?echo $row['idcourse'];?>"><img src="../../gambar/menu/zoom4.png" width="22" height="22" /></a></td>
	</tr>
	<?
	}
	?>
