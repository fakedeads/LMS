...
$downloadFile=mysql_query("select * FROM tb_mdl_data_file WHERE idcategori='$idcategori' AND idcourse='$idcourse' AND tglbuka<='$tglSekarang' AND tgltutup>='$tglSekarang'
AND namatypefile='pdf' OR namatypefile='doc' OR namatypefile='doct'
");//
$downloadGambar=mysql_query("select * FROM tb_mdl_data_file WHERE idcategori='$idcategori' AND idcourse='$idcourse' AND tglbuka<='$tglSekarang' AND tgltutup>='$tglSekarang'
AND namatypefile='jpg' OR namatypefile='png' OR namatypefile='gif'
");//
$downloadAplikasi=mysql_query("select * FROM tb_mdl_data_file WHERE idcategori='$idcategori' AND idcourse='$idcourse' AND tglbuka<='$tglSekarang' AND tgltutup>='$tglSekarang'
AND namatypefile='exe' OR namatypefile='jar'
");//
$downloadcompres=mysql_query("select * FROM tb_mdl_data_file WHERE idcategori='$idcategori' AND idcourse='$idcourse' AND tglbuka<='$tglSekarang' AND tgltutup>='$tglSekarang'
AND namatypefile='zip' OR namatypefile='rar'
");//
$downloadLain=mysql_query("select * FROM tb_mdl_data_file WHERE idcategori='$idcategori' AND idcourse='$idcourse' AND tglbuka<='$tglSekarang' AND tgltutup>='$tglSekarang'
...
<tr>
	...
	<th width="297" align="center">Judul</th>
...
<?php
	...
	{
		?>
<div style="font-style: italic; padding-top: 3px; padding-bottom: 3px; font-size: 15">Type Lain-Lain</div>
<table border="1" align="center">
<?php
