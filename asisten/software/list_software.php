...
<?php
$query = "SELECT id, name FROM tb_mdl_coursecategories";
			...
			<form action="" method="post" enctype="multipart/form-data"
				...
				<div>
					<table align="center" border="1">
						<tr>
							<th width="30px" align="center">No</td>
							<th width="280px" align="center">Nama Software</td>
							<th width="110px" align="center">Lihat Software</td>
						</tr>
						<?php do{ $no++;?>
						...
						<tr>
							...
							<td align="center"><a
								href="lihat_software.php?id=<?php echo $data['id'];?>"><img
									src="../../gambar/menu/zoom4.png"> </a></td>
						</tr>
