            ...
            <!-- /widget-header -->
              <div class="widget big-stats-container">
				<div class="alert alert-warning" align="center">
					...
					?>
					<h3 class="bigstats" align="center">Jadwal Praktikum Asisten Teknik Elektro <br/>Semester <?php echo $data['semester']?> Tahun Akademik <?php echo $data['akademik'] ?> <br/> Asisten :  <?php echo $nama?> </h3><br/>
