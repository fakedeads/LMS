...
<?php
$query ="SELECT * FROM tb_mdl_upload_video";
          ...
          <div class="widget widget-nopad">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
                  <h6 class="bigstats" align="center">Video Tutorial</h6>
			...
			<div style="margin-top: 20px; margin-bottom: 15px;">
				<table align="center" border="1">
					<tr>
						...
						<th width="245px" align="center">Nama Video</th>
						<th width="90px" align="center">Ukuran</th>
						<th width="90px" align="center">Tanggal</th>
						<th width="70px" align="center">Putar</th>
						<th width="70px" align="center">Download</th>
					</tr>
					<?php do{ $no++;?>
					...
					<tr>
						...
						<td><?php echo basename($data['path'],".flv");?>
						</td>
						<td align="center"><?php echo $data['size'];?>
						</td>
						<td align="center"><?php echo $data['date'];?>
						</td>
						<td align="center"><a
							href="../../tatausaha/video_play.php?id=<?php echo $data['id'];?>"><img
								src="../../gambar/menu/play.png"> </a>
						</td>
						<td align="center"><a
							href="../../tatausaha/video_download.php?id=<?php echo $data['id'];?>"><img
								src="../../gambar/menu/download.png"> </a>
						</td>
					</tr>
